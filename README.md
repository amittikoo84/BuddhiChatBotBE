Express & ES6 REST API For the Buddhi ChatBot
==================================
...
This is a straightforward Node App for building REST APIs with ES6 and Express.
...
```sh
# clone it
https://github.com/amittikoo84/BuddhiChatBotBE.git
cd BuddhiChatBotBE
